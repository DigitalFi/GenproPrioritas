...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.MyViewHolder>
    ...
    public SearchAdapter(Context context, List<SearchData> contactList, ContactsAdapterListener listener) {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (SearchData row : contactList) {
                        ...
                        if (row.getUser_name().toLowerCase().contains(charString.toLowerCase()) || row.getEmail().contains(charSequence)) {
