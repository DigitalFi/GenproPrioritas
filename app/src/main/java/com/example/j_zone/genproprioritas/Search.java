...
public class Search extends AppCompatActivity implements SearchAdapter.ContactsAdapterListener {
    ...
    private static final String URL = "http://genprodev.lavenderprograms.com/apigw/users";
    @Override
    ...
    public void onContactSelected(SearchData searchData) {
        Toast.makeText(this, "Selected :" +searchData.getUser_name(), Toast.LENGTH_SHORT).show();
    }
}
